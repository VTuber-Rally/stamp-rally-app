export const orangeTriangleEmphasis = {
  ...
  1: (
    <span className="font-bold whitespace-nowrap underline decoration-success-orange decoration-dashed decoration-2" />
  ),
} as const;
...
export const pinkSquareEmphasis = {
  ...
  1: (
    <span className="font-bold whitespace-nowrap underline decoration-tertiary decoration-dashed decoration-2" />
  ),
} as const;
